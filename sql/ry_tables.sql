...
(
    ...
    primary key (dept_id)
) engine=innodb DEFAULT CHARSET=utf8mb4  auto_increment=200 comment = '部门表';
...
(
    ...
    nick_name   varchar(300) not null comment '用户昵称',
    ...
    del_flag    char(1)      default '0' comment '删除标志（0表存在 2代表删除）',
...
values (1, 103, 'admin', '管理员', '00', 'ry@163.com', '15888888888', '1', '',
        '$2a$10$Mxn4D.H81JzcOG2Y0Vmj6.H4AA5iCPMuzKbP9bGpBUSH7NhnGxxdC', '0', '0', '127.0.0.1', sysdate(), 'admin',
        sysdate(), '', null, '管理员');
-- admin密码明文： Cj123456!
insert into sys_user
values (2, 105, 'u1', '用户一', '00', 'ry@qq.com', '15666666666', '1', '',
...
(
    ...
    remark              varchar(500) default null comment '备注',
    primary key (role_id)
) engine=innodb DEFAULT CHARSET=utf8mb4 auto_increment=100 comment = '角色信息表';

-- ----------------------------
-- 初始化-角色信息表数据
-- ----------------------------
insert into sys_role
values ('1', '系统管理员', 'admin', 1, 1, 1, 1, '0', '0', 'admin', sysdate(), '', null, '超级管理员');
insert into sys_role
values ('2', '审计管理员', 'audit', 2, 2, 1, 1, '0', '0', 'admin', sysdate(), '', null, '审计员');
insert into sys_role
values ('3', '安全管理员', 'security', 3, 3, 1, 1, '0', '0', 'admin', sysdate(), '', null, '安全管理员');
...
(
    ...
    primary key (menu_id)
) engine=innodb DEFAULT CHARSET=utf8mb4 auto_increment=2000 comment = '菜单权限表';
...
) engine=innodb DEFAULT CHARSET=utf8mb4 auto_increment=100 comment = '操作日志记录';
...
(
    ...
    primary key (dict_id),
    unique (dict_type)
) engine=innodb DEFAULT CHARSET=utf8mb4 auto_increment=100 comment = '字典类型表';
...
) engine=innodb DEFAULT CHARSET=utf8mb4 auto_increment=100 comment = '字典数据表';
...
) engine=innodb DEFAULT CHARSET=utf8mb4 auto_increment=100 comment = '参数配置表';

INSERT INTO security1.sys_config (config_name, config_key, config_value, config_type, create_by, create_time, update_by,
                                  update_time, remark)
VALUES ('主框架页-默认皮肤样式名称', 'sys.index.skinName', 'skin-blue', 'Y', 'admin', '2025-02-25 01:42:33', '', NULL,
        '蓝色 skin-blue、绿色 skin-green、紫色 skin-purple、红色 skin-red、黄色 skin-yellow'),
       ('用户管理-账号初始密码', 'sys.user.initPassword', 'Bjgd123!', 'Y', 'admin', '2025-02-25 01:42:33', '', NULL,
        '初始化密码 123456'),
       ('主框架页-侧边栏主题', 'sys.index.sideTheme', 'theme-dark', 'Y', 'admin', '2025-02-25 01:42:33', '', NULL,
        '深色主题theme-dark，浅色主题theme-light'),
       ('账号自助-验证码开关', 'sys.account.captchaEnabled', 'true', 'Y', 'admin', '2025-02-25 01:42:33', '', NULL,
        '是否开启验证码功能（true开启，false关闭）'),
       ('账号自助-是否开启用户注册功能', 'sys.account.registerUser', 'false', 'Y', 'admin', '2025-02-25 01:42:33', '',
        NULL, '是否开启注册用户功能（true开启，false关闭）'),
       ('用户登录-黑名单列表', 'sys.login.blackIPList', '', 'Y', 'admin', '2025-02-25 01:42:33', '', NULL,
        '设置登录IP黑名单限制，多个匹配项以;分隔，支持匹配（*通配、网段）'),
       ('访问控制开关', 'access.switch', 'false', 'N', 'admin', '2025-03-04 15:06:44', 'admin', '2025-03-04 16:58:05',
        '访问控制开关');
...
) engine=innodb DEFAULT CHARSET=utf8mb4 auto_increment=100 comment = '系统访问记录';
...
) engine=innodb DEFAULT CHARSET=utf8mb4 auto_increment=100 comment = '定时任务调度表';
...
) engine=innodb DEFAULT CHARSET=utf8mb4 auto_increment=10 comment = '通知公告表';
...
) engine=innodb DEFAULT CHARSET=utf8mb4 auto_increment=1 comment = '代码生成业务表';
...
) engine=innodb DEFAULT CHARSET=utf8mb4 auto_increment=1 comment = '代码生成业务表字段';


-- modbus相关字典
INSERT INTO security1.sys_dict_type
(dict_id, dict_name, dict_type, status, create_by, create_time, update_by, update_time, remark)
VALUES(100, 'Modbus功能码', 'access_modbus_function_code', '0', 'admin', '2025-03-03 10:59:16', '', NULL, 'Modbus功能码。');

INSERT INTO security1.sys_dict_type
(dict_id, dict_name, dict_type, status, create_by, create_time, update_by, update_time, remark)
VALUES(101, 'Modbus读写操作类型', 'access_modbus_rw', '0', 'admin', '2025-03-03 11:01:06', 'admin', '2025-03-03 11:02:13', 'Modbus读写操作类型');

INSERT INTO security1.sys_dict_data
...
VALUES(100, 1, '读线圈', '01', 'access_modbus_function_code', NULL, 'default', 'N', '0', 'admin', '2025-03-03 11:14:20', '', NULL, NULL);
INSERT INTO security1.sys_dict_data
(dict_code, dict_sort, dict_label, dict_value, dict_type, css_class, list_class, is_default, status, create_by, create_time, update_by, update_time, remark)
VALUES(102, 3, '写单个线圈', '05', 'access_modbus_function_code', NULL, 'default', 'N', '0', 'admin', '2025-03-03 11:15:19', 'admin', '2025-03-03 11:17:42', '写单个线圈');
INSERT INTO security1.sys_dict_data
(dict_code, dict_sort, dict_label, dict_value, dict_type, css_class, list_class, is_default, status, create_by, create_time, update_by, update_time, remark)
VALUES(103, 2, '读保持寄存器', '03', 'access_modbus_function_code', NULL, 'default', 'N', '0', 'admin', '2025-03-03 11:15:49', 'admin', '2025-03-03 11:17:49', '读保持寄存器');
INSERT INTO security1.sys_dict_data
(dict_code, dict_sort, dict_label, dict_value, dict_type, css_class, list_class, is_default, status, create_by, create_time, update_by, update_time, remark)
VALUES(104, 4, '写单个寄存器', '06', 'access_modbus_function_code', NULL, 'default', 'N', '0', 'admin', '2025-03-03 11:16:57', '', NULL, NULL);
INSERT INTO security1.sys_dict_data
(dict_code, dict_sort, dict_label, dict_value, dict_type, css_class, list_class, is_default, status, create_by, create_time, update_by, update_time, remark)
VALUES(105, 1, '读', '0', 'access_modbus_rw', NULL, 'default', 'N', '0', 'admin', '2025-03-03 11:18:41', '', NULL, NULL);
INSERT INTO security1.sys_dict_data
(dict_code, dict_sort, dict_label, dict_value, dict_type, css_class, list_class, is_default, status, create_by, create_time, update_by, update_time, remark)
VALUES(106, 2, '写', '2', 'access_modbus_rw', NULL, 'default', 'N', '0', 'admin', '2025-03-03 11:18:58', '', NULL, NULL);
